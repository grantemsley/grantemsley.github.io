...
function onOpen() {
  ...
  // make sure laser mode is disabled
  writeln("$32=0");
  // Move above stock surface
  writeComment("Move 1.5 cm above stock top");
  writeBlock(gUnitModal.format(21));
  writeBlock(gMotionModal.format(0), zOutput.format(getGlobalParameter('stock-upper-z')+15));
  writeComment("Start spindle then pause");
  writeln("S30000 M3");
